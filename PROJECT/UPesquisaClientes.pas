...
begin
  ...
  try
    formRel.LblTitulo.Caption := 'Relatório de Clientes';
    ...
    begin
      formRel.MemoPrint.Lines.Add('Código: ' + QPesquisaCliente.FieldByName('id_cliente').AsString);
      formRel.MemoPrint.Lines.Add('Nome: ' + QPesquisaCliente.FieldByName('nome').AsString);
      formRel.MemoPrint.lines.add('Endereço: ' + qPesquisacliente.FieldByName('endereco').asstring + ' numero: ' + qPesquisacliente.FieldByName('numero').AsString);
